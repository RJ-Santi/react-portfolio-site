      ...
      <Carousel>
            ...
            <div className="overlay">
              <div className="overlay-text">Click to View <br /> To-Do List Project</div>
                <Carousel.Caption>
                  ...
                  <p>This application allows you to add and remove items from a list. It uses local storage to save your list for future uses.</p>
                  <small className="text-muted">Built with: HTML, CSS, Bootstrap, JS</small>
                </Carousel.Caption>
            </div>
          </a>
        </Carousel.Item>
        ...
        <Carousel.Item>
          <a href="https://rj-santi.github.io/weather-app/" className="stretched-link" target="_blank" rel='noreferrer'>
            ...
            />
            <div className="overlay">
              <div className="overlay-text">Click to View <br /> Weather Project</div>
                <Carousel.Caption>
                  <h3>Weather Project</h3>
                  <p>This application detects the user's location with Geolocation API and accesses the API from OpenWeatherMap.com in order to show the weather for the user's location.</p>
                  <small className="text-muted">Built with: HTML, CSS, Bootstrap, JS</small>
                </Carousel.Caption>
            </div>
          </a>
            ...
            <div className="overlay">
              <div className="overlay-text">Click to View <br />Github Finder Project</div>
                <Carousel.Caption>
                  ...
                  <p>This application can be used to find Github users by name. It displays a full profile for the user including statistics and links to the profile and repos.</p>
                  <small className="text-muted">Built with: HTML, CSS, Tailwind, DaisyUI, JS, React</small>
                </Carousel.Caption>
            </div>
          </a>
        </Carousel.Item>
            ...
            <div className="overlay">
              <div className="overlay-text">Click to View <br />Feedback UI Project</div>
                <Carousel.Caption>
                  ...
                  <p>This application can be used to add feedback functionality to an existing site.</p>
                  <small className="text-muted">Built with: HTML, CSS, Tailwind, JS, React</small>
                </Carousel.Caption>
            </div>
          </a>
        </Carousel.Item>
